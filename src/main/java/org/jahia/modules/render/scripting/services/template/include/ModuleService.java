...
public class ModuleService implements ScriptingService {
    ...
    /**
     * Returns <code>null</code> if the node we're looking at doesn't have the editable in contribution mode property,
     * otherwise returns the value of the property.
     *
     * @param node the node we're interested in
     * @return <code>null</code> if the node we're looking at doesn't have the editable in contribution mode property,
     * otherwise returns the value of the property.
     * @throws RepositoryException
     */
