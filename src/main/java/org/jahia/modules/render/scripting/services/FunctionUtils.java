...
public class FunctionUtils {
    ...
    /**
     * Joins the elements of the provided array/collection/iterator into a single String containing the provided
     * elements with specified
     * separator.
     *
     * @param elements  the set of values to join together, may be null
