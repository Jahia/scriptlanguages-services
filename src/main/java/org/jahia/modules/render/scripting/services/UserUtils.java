package org.jahia.modules.render.scripting.services;
...
public class UserUtils {
     ...
     * @return the user for the specified user key or name or <code>null</code> if the corresponding user cannot be
     * found
    ...
    /**
     * Returns whether the current user can be assigned to the specified task (as represented by the specified
     * JCRNodeWrapper).
     *
